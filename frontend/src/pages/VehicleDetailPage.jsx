...
export default function VehicleDetailPage() {
  ...
  const tabs = ['Overview', 'Specs', 'Location']
      ...
      <main className="max-w-screen-2xl mx-auto px-gutter mt-8 mb-section-padding-lg">
        ...
        <div className="flex flex-col md:flex-row gap-10">
          ...
          <section className="w-full md:w-[58%]">
            ...
            {/* ── REVIEWS SECTION ── */}
            <div id="reviews" className="mt-12 border-t border-outline-variant/30 pt-10 px-4 pb-6">
              {/* Section header */}
              ...
              {reviewsLoading ? (
                ...
                <>
                  ...
                  <div className="bg-surface-container rounded-2xl p-6 mb-4 border border-outline-variant">
                    <div className="flex flex-col sm:flex-row gap-6 items-center sm:items-start">
                      ...
                      <div className="flex flex-col items-center justify-center min-w-[100px]">
                        ...
                        <div className="flex gap-0.5 mt-2">
                          {[1,2,3,4,5].map(i => (
                            <span key={i} 
                              className={`text-sm ${i <= Math.round(Number(stats.average)) ? 'text-amber-400' : 'text-outline-variant'}`}>
                              ★
                            </span>
                          ))}
                        </div>
